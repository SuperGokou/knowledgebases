...
knowledgebases-web / Root=web/    -> Next.js、HttpOnly BFF、登录与管理 UI
```
...
```powershell
Push-Location web
npx --yes vercel@50.28.0 link --yes --project knowledgebases-demo
npx --yes vercel@50.28.0 env ls
npx --yes vercel@50.28.0 --prod
Pop-Location
```
...
Invoke-WebRequest https://<web-project>.vercel.app/login
