...
const features: Array<{ href: string; icon: IconName; title: string; detail: string }> = [
  { href: "/admin/knowledge", icon: "book", title: "知识库", detail: "组织业务域与检索范围" },
  { href: "/admin/files", icon: "file", title: "文件中心", detail: "直传、审核与状态追踪" },
...
export function AdminFeatureList() {
  ...
  const visible = features.filter((feature) => canAccessPath(feature.href, me));
